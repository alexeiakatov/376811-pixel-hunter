...
describe(`*** TEST getResultScore() in game-data.js ***`, () => {
  ...
  // Если в массиве ответов менее 10 ответов.
  it(`Должна возвращать -1, если массив playerAnswers содержит менее 10ти ответов.`, () => {
    for (let i = 0; i < 10; i++) {
  ...
  it(`Должна вернуть 650, если все ответы верные, но медленные.`, () => {
    let playerAnswers = new Array(10);
    playerAnswers.fill({isCorrect: true, time: 20001});
